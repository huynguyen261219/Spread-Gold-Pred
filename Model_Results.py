...
st.markdown(
    "<h3 class='section-title'>Model Performance Summary</h3>", unsafe_allow_html=True
)
...
st.markdown(
    "<h3 class='section-title'>Actual vs Predicted Spread</h3>", unsafe_allow_html=True
)

fig1 = go.Figure()

fig1.add_trace(go.Scatter(x=test.index, y=test["Actual"], mode="lines", name="Actual"))
